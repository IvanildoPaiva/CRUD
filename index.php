      ...
      ?>
          <tr>
            ...
            <td class="text-center">
              <a class="btn btn-success btn-sm " href="edit.php?id=<?= $row['id']; ?>"><i class="bi bi-pencil"></i> Edit</a>
            </td>
            <td class="text-center">
              <a class="btn btn-danger btn-sm " href="delete.php?id=<?= $row['id']; ?>"><i class="bi bi-trash3"></i> Deletar</a>
            </td>
          </tr>
